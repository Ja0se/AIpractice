...
from ar_dataloader import TrainDataset, TestDataset
...
model=ARCNN()
model.load_state_dict(torch.load('arcnn.pth'))
...
# torch.save(model.state_dict(),"arcnn.pth")
...
for data in test_dataloader:
    ...
    cv2.imwrite('.\\AR_dataset\\Set5_Pred/'+name[-1],predImg)
